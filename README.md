...
| `GPIO_17` |       `11`        | :yellow_square: I1             |        `%IX0.3`        |   :white_check_mark:   |
| `GPIO_18` |       `12`        | :orange_square: PWM_0 *@ TODO* |        `%QW0.0`        |   :white_check_mark:   |
| `GPIO_19` |       `35`        | :orange_square: PWM_1 *@ TODO* |        `%QX1.0`        |   :white_check_mark:   |
